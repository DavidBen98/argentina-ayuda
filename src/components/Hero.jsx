  ...
  return (
    <section className="text-gray-600 body-font ">
        <div className="container mx-auto flex px-5 h-4/5 md:flex-row flex-col pb-20 justify-center">
            <div className="lg:flex-grow justify-center md:w-1/2 lg:pr-24 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center max-w-md sm:m-auto">
