  ...
  return (
    <>
      ...
      <div className='flex flex-wrap items-center justify-center'>
        <div className='flex content-center flex-wrap lg:w-10/12 text-center md:text-left bg-cyan-50 w-full px-8 md:px-16 py-8 rounded'>
          <div className='w-full m-auto md:w-9/12 order-2 md:order-1'>
            <section className='w-full'>
              <h2 className='font-bold pt-8 pb-4 text-2xl'>
                About us?
              </h2>
